...
/**
 * Read-only rendering of a shared chat, plus the shared loading/error cards.
 * Used by /share (self-contained links) and /share/[shareId] (legacy links).
 * The design is unchanged from the original disk-based share page.
 */

import React from 'react';
import Link from 'next/link';
import MarkdownRenderer from '@/components/MarkdownRenderer';
import { ShareMessage } from '@/lib/shareLink';

export function SharedChatLoading() {
  return (
...
export function SharedChatError({ title, message }: { title: string; message: string }) {
  return (
...
export function SharedChatView({ title, sharedAt, messages }: SharedChatViewProps) {
