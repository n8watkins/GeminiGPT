...
import { ChatBubbleLeftRightIcon, MagnifyingGlassIcon, DocumentTextIcon, KeyIcon, CodeBracketIcon, BoltIcon, GlobeAltIcon } from '@heroicons/react/24/outline'

/**
 * The "what is this project" content, shared between the first-run
 * onboarding wizard (step 1) and the About modal in the sidebar.
 */
                    ...
                    <div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                            ...
                            <div className="flex items-start space-x-3 p-3 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-900/20 dark:to-emerald-900/20 rounded-lg border border-green-200 dark:border-green-800">
                                ...
                                <div>
                                    <p className="text-sm font-bold text-gray-900 dark:text-white">Free To Try, BYOK Optional</p>
                                    <p className="text-xs text-gray-600 dark:text-gray-300">Chat instantly on the shared demo key, or bring your own free Gemini key ($300 credits) for unlimited use</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-start space-x-3 p-3 bg-purple-50 dark:bg-purple-900/20 rounded-lg border border-purple-200 dark:border-purple-800">
                                ...
                                <div>
                                    <p className="text-sm font-bold text-gray-900 dark:text-white">Cross-Chat Memory</p>
                                    <p className="text-xs text-gray-600 dark:text-gray-300">Chats here remember each other &mdash; tell one chat something, ask about it in another (LanceDB vector embeddings)</p>
                                </div>
                            </div>
