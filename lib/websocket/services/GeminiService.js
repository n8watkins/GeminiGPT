...
class GeminiService {
  ...
  createModel(modelName = 'gemini-2.5-flash', apiKey = null) {
    // If user provided their own API key (BYOK), create a new GoogleGenerativeAI instance
    const genAI = apiKey ? new (require('@google/generative-ai').GoogleGenerativeAI)(apiKey) : this.genAI;
