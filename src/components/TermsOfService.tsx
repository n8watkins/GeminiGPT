...
export default function TermsOfService({ isOpen, onClose }: TermsOfServiceProps) {
  ...
  return (
    <div className="fixed inset-0 bg-black/40 backdrop-blur-md z-[50000] flex items-center justify-center p-4" onClick={onClose}>
      <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-2xl shadow-blue-500/20 dark:shadow-blue-500/40 max-w-4xl w-full max-h-[90vh] overflow-y-auto border border-blue-200 dark:border-gray-700" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="p-6 space-y-6">
          ...
          <section className="bg-blue-50 dark:bg-blue-900/20 border-l-4 border-blue-600 dark:border-blue-500 p-4 rounded">
            ...
            <div className="space-y-3 text-gray-700 dark:text-gray-300">
              ...
              <div className="bg-white dark:bg-gray-800 p-3 rounded border border-blue-200 dark:border-blue-800">
                <h4 className="font-semibold text-gray-900 dark:text-white mb-2">How Your API Key Works:</h4>
          ...
          {/* Use of Service */}
          <section>
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Use of Service</h3>
          ...
          {/* Data Collection */}
          <section>
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Data Collection & Storage</h3>

            <div className="space-y-3 text-gray-700 dark:text-gray-300">
              <div>
                <h4 className="font-semibold text-gray-900 dark:text-white mb-2">What We Store:</h4>
              ...
              <div>
                <h4 className="font-semibold text-gray-900 dark:text-white mb-2">What We DO NOT Store:</h4>
                <ul className="space-y-1 ml-4">
                  <li className="flex items-start">
          ...
          <section>
            ...
            <p className="text-gray-700 dark:text-gray-300 mb-2">This application uses:</p>
            <ul className="space-y-2 text-gray-700 dark:text-gray-300">
              <li className="flex items-start">
                <span className="mr-2">•</span>
                <span><strong>Google Gemini AI:</strong> Subject to <a href="https://ai.google.dev/gemini-api/terms" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline">Google&apos;s Terms</a></span>
              </li>
              <li className="flex items-start">
                <span className="mr-2">•</span>
          ...
          {/* Disclaimers */}
          <section>
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Disclaimers</h3>
            <div className="bg-yellow-50 dark:bg-yellow-900/20 border border-yellow-200 dark:border-yellow-800 rounded p-4 text-gray-700 dark:text-gray-300">
          ...
          {/* Contact */}
          <section>
            <h3 className="text-xl font-semibold text-gray-900 dark:text-white mb-3">Contact & Questions</h3>
            <p className="text-gray-700 dark:text-gray-300">
            ...
            <ul className="space-y-2 text-gray-700 dark:text-gray-300 mt-2">
              <li className="flex items-start">
                <span className="mr-2">•</span>
                <span><strong>GitHub:</strong> <a href="https://github.com/n8watkins/gemini-chat-app" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline">View Source Code</a></span>
              </li>
              <li className="flex items-start">
                <span className="mr-2">•</span>
                <span><strong>Portfolio:</strong> <a href="https://n8sportfolio.vercel.app/" target="_blank" rel="noopener noreferrer" className="text-blue-600 dark:text-blue-400 hover:underline">Nathan Watkins</a></span>
              </li>
            </ul>
          </section>
